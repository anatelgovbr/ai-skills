...
| `conformidade-de-escrita-normativa` | [https://github.com/anatelgovbr/ai-skills](https://github.com/anatelgovbr/ai-skills) | Analisar a conformidade de redação de minutas de atos normativos brasileiros | Automático ou pelo nome exato |
