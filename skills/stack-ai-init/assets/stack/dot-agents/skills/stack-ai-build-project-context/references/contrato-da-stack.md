...
| `Disciplina Agentica` | regra fixa da stack | quatro passos numerados em subsecoes `###`, cada um com tese em negrito, topicos e teste de saida; o passo 4 traz o checklist de execucao. Os nomes dos quatro passos abrem o arquivo, como lista numerada, no lugar de um titulo | texto que chega pronto da instalacao e vale igual em todo projeto; a rodada preserva o texto e nao acrescenta principio |
