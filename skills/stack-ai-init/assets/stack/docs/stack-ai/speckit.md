...
> **Não é necessário instalar o SpecKit.** Toda a estrutura já está presente no repositório. O único requisito é ter uma das ferramentas de IA listadas em [`stack-de-ia.md`](stack-de-ia.md) instalada e configurada.
